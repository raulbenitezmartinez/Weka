...
public class BIANDML {
	...
	public static void main(String[] args) throws Exception {
		...
		int cantidad_de_atributos = 11;//12 atributos numericos y 1 atributo de clase.
		int cantidad_de_ejemplos = 36;//Cantidad de ejemplos para nuestro modelo.
		int cantidad_de_etiquetas = 5;//El atributo de clase tiene dos posibles valores: 0 o 1.
		int pos_atributo_clase = 10;//Weka indexara de 0 a 12 los 13 atributos. En el indice 12 estara el atributo de clase.
		boolean tiene_encabezado = true;
		
		//Declaramos 12 atributos numericos.
		Attribute a1 = new Attribute("kpi_crec_fidelidad");
		Attribute a2 = new Attribute("kpi_cli_fieles");
		Attribute a3 = new Attribute("kpi_tasa_abandonismo");
		Attribute a4 = new Attribute("kpi_tiket_medio");
		Attribute a5 = new Attribute("kpi_cifra_ventas");
		Attribute a6 = new Attribute("kpi_margen_comercial");
		Attribute a7 = new Attribute("kpi_rotacion_stock");
		Attribute a8 = new Attribute("kpi_coef_rentabilidad");
		Attribute a9 = new Attribute("kpi_cobertura_stock");
		Attribute a10 = new Attribute("kpi_dif_inventario");
		...
		val_atri_class.addElement("Nada");
		val_atri_class.addElement("Poco");
		val_atri_class.addElement("Bastante");		
		val_atri_class.addElement("Mucho");
		val_atri_class.addElement("Demasiado");
		
		Attribute an_clase = new Attribute("resultado", val_atri_class);

		//Declaramos el vector de caracteristicas.
		FastVector atributos = new FastVector(cantidad_de_atributos);
		atributos.addElement(a1);
		atributos.addElement(a2);
		atributos.addElement(a3);
		atributos.addElement(a4);
		atributos.addElement(a5);
		atributos.addElement(a6);
		atributos.addElement(a7);
		atributos.addElement(a8);
		atributos.addElement(a9);
		atributos.addElement(a10);
		atributos.addElement(an_clase);
		...
		String archivo_testing = "C:\\Users\\raul\\Google Drive\\TESIS-BI-ML\\Weka\\WekaPracticas\\3_Codificacion_Tesis\\datos.arff";
		...
		try{
			...
			for (int i = 0; i < cantidad_de_atributos - 1; i++){
				nuevo_ejemplo.setValue(conjunto_entrenamiento.attribute(i),Double.parseDouble("0.5"));
			}
